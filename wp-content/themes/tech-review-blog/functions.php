...
function tech_review_blog_enqueue_google_fonts() {
	...
	wp_enqueue_style(
		'ibm-plex-sans',
		wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,100..700;1,100..700&display=swap' ),
		array(),
		'1.0'
	);
}
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			...
			echo '<div class="notice-content">';
				...
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=tech_review_blog_about' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'tech-review-blog' ) .'</a></span>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
}
