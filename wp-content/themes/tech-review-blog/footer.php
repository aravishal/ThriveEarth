...
<footer class="footer-side">
  <div class="footer-widget">
    <div class="container">
      ...
      <?php $tech_review_blog_count = 0;
        if ( is_active_sidebar('footer1-sidebar') ) : $tech_review_blog_count++; endif; 
        if ( is_active_sidebar('footer2-sidebar') ) : $tech_review_blog_count++; endif; 
        if ( is_active_sidebar('footer3-sidebar') ) : $tech_review_blog_count++; endif; 
        if ( is_active_sidebar('footer4-sidebar') ) : $tech_review_blog_count++; endif;
        $tech_review_blog_row = 'col-lg-'. 12/$tech_review_blog_count .' col-md-6 col-sm-12';
      ?>
      <div class="row pt-2">
          <?php if ( is_active_sidebar('footer1-sidebar') ) : ?>
              <div class="footer-area <?php echo esc_attr($tech_review_blog_row); ?>">
